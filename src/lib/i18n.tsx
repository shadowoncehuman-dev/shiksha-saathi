  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "What are the exam dates?", a: "The examination is scheduled for 11 April 2027 at Govt. School, Nayagaon. Group A (classes 6–8) will be held 11:00–12:30 and Group B (classes 9–12) 14:00–16:00." },
    ...
    invigilator: {
      ...
      qrInstructions: "Scan the QR code on the student's admit card to verify their identity",
      ...
      duplicateBlocked: "This student is already registered. Duplicate registration is not allowed.",
      phoneSpamWarning: "This phone number has been used for multiple registrations.",
    },
  },
  ...
  hi: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "परीक्षा की तिथि क्या है?", a: "परीक्षा 11 अप्रैल 2027 को सरकारी स्कूल, नयागांव में आयोजित की जाएगी। समूह A (कक्षा 6–8) सुबह 11:00–12:30 और समूह B (कक्षा 9–12) दोपहर 14:00–16:00 होगा।" },
    ...
    invigilator: {
      title: "निरीक्षक डैशबोर्ड",
      enterPassword: "पासवर्ड दर्ज करें",
      login: "लॉगिन",
      wrongPassword: "गलत पासवर्ड",
      searchTab: "खोजें",
      allStudentsTab: "सभी छात्र",
      qrTab: "QR स्कैनर",
      searchPlaceholder: "रोल नंबर या नाम से खोजें...",
      noResults: "कोई छात्र नहीं मिला",
      qrInstructions: "छात्र के प्रवेश पत्र पर QR कोड स्कैन करके पहचान सत्यापित करें",
      startScan: "स्कैनर शुरू करें",
      stopScan: "स्कैनर बंद करें",
      verified: "छात्र सत्यापित",
      notVerified: "सत्यापन विफल",
      studentNotFound: "छात्र डेटाबेस में नहीं मिला",
      duplicateBlocked: "यह छात्र पहले से पंजीकृत है। डुप्लिकेट पंजीकरण की अनुमति नहीं है।",
      phoneSpamWarning: "इस फोन नंबर का उपयोग कई पंजीकरणों के लिए किया गया है।",
    },
  },
};
